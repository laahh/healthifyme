/**
 * Konversi string durasi olahraga (screenshot fitness) ke menit (bilangan bulat).
 * Mendukung: "1:28:47" (j:m:dt), "0:45" (j:m), "45:30" (m:dt jika bagian pertama > 24), "30 menit", angka saja = menit.
